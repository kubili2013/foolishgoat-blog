            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-10">
                    ...
                    <div class="form-group {{$errors->has('thumbnail')?" has-error":""}}">
                        ...
                        {!! Form::text('thumbnail',old('thumbnail'),['class'=>'form-control','placeholder'=> __('Article Thumbnail') . '  http://foolishgoat.com/0001.jpg']) !!}
                    </div>
                            ...
                            <div class="blockquote blockquote-primary">
                                ...
                                @foreach($tags as $tag)
                                    <div class="checkbox col-lg-3 col-md-4 col-sm-6" style="display: inline-block;">
                                        {!! Form::checkbox("tags[]", $tag->id, false,['id' => "tags".$tag->id]) !!}
