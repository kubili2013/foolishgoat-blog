            ...
            <div class="content-center text-center">
                ...
                <div class="row" style="width:100%;margin:0px;padding-top:40px;">
                    <div  class="col-xs-3 col-sm-3 col-md-3 text-center" style="padding:0px;">
                        <div id="image_menu_1" class="image-menu" rel="tooltip" title="{{__('welcome.Article')}}" data-placement="bottom">
                    ...
                    <div class="col-xs-9 col-sm-9 col-md-9 text-center">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center" style="padding:0px;">
                                <div id="image_menu_2" class="image-menu" rel="tooltip" title="{{__('welcome.Share')}}" data-placement="bottom">
                                    <i class="fa fa-share-alt"></i>
                                </div>
                            </div>
                            <div class="col-xs-8 col-sm-8 col-md-8 text-center" style="padding:0px;">
                                <div id="image_menu_3" class="image-menu" rel="tooltip" title="{{__('welcome.Diary')}}" data-placement="bottom">
                        ...
                        <div class="row">
                            <div class="col-xs-8 col-sm-8 col-md-8 text-center" style="padding:0px;">
                                <div id="image_menu_4" class="image-menu" rel="tooltip" title="{{__('welcome.Picture')}}" data-placement="bottom">
                                    <i class="fa fa-camera"></i>
                                </div>
                            </div>
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center" style="padding:0px;">
                                <div id="image_menu_5" class="image-menu" rel="tooltip" title="{{__('welcome.Enshrine')}}" data-placement="bottom">
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    <a href="#" target="_blank">FoolishGoat</a>.
                </div>
            </div>
        </footer>
    </div>
